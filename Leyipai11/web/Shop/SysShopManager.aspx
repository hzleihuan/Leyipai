<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SysShopManager.aspx.cs" Inherits="Shop_SysShopManager" %>
        ...
        <table style="width: 849px;">
                    ...
                    <asp:Panel ID="editPanel" runat="server"  Visible="False" Width="100%">
                        ...
                        <div style="border-right: #a4d5e3 1px solid; border-top: #a4d5e3 1px solid; background: url(../images/content_bg1.gif) repeat-x 50% bottom;
                            ...
                            <div style="margin: 5px">
                                <table style="width: 505px; height: 208px;">
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width: 43%; height: 43px">
                                            <span style="font-size: 10pt; font-family: 宋体">网店网址</span></td>
                                        <td style="width: 50%; height: 43px">
                                            <asp:TextBox ID="ShopUrl_Edit" runat="server" Width="260px"></asp:TextBox></td>
                                        <td style="width: 40%; height: 43px">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 43%; height: 43px">
                                            消费平台</td>
                                        <td style="width: 50%; height: 43px">
                                            <asp:DropDownList ID="PlatformID_Edit" runat="server" 
                    ...
                    <asp:Panel ID="viewPanel" runat="server"  Width="125px">
                        <div style="border-right: #a4d5e3 1px solid; border-top: #a4d5e3 1px solid; background: url(../images/content_bg1.gif) repeat-x 50% bottom;
                            ...
                            <h2 style="padding-right: 0px; padding-left: 8px; font-size: 14px; background: #e2f3fa;
                                ...
                                &nbsp;</h2>
                            <div style="margin: 5px">
                                <table style="width: 581px; height: 203px;">
                                    <tr>
                                        <td style="width: 29%; height: 43px">
                                            <span style="font-size: 10pt; font-family: 宋体">网店</span>名称</td>
                                        <td style="width: 50%; height: 43px">
                                    ...
                                    <tr>
                                        <td style="width: 29%; height: 43px">
                                            <span style="font-size: 10pt; font-family: 宋体">网店网址</span></td>
                                        <td style="width: 50%; height: 43px">
                                            <asp:TextBox ID="ShopUrl" runat="server" Width="260px"></asp:TextBox></td>
                                        <td style="width: 40%; height: 43px">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 29%; height: 43px">
                                            消费平台</td>
                                        <td style="width: 50%; height: 43px">
                                            <asp:DropDownList ID="PlatformID" runat="server" DataSourceID="ObjectDataSource1"
                                                DataTextField="PlatformName" DataValueField="PlatformID">
                                            </asp:DropDownList>
                                        </td>
                                        <td style="width: 40%; height: 43px">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                            BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Width="727px">
                            <FooterStyle BackColor="#99CCCC" ForeColor="#003399" />
                            <Columns>
                                <asp:BoundField DataField="ShopID" HeaderText="编号"  >
                                    <ControlStyle Width="100px" />
                                    <HeaderStyle Width="80px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="ShopName" HeaderText="店名"  >
                                    <ControlStyle Width="150px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="PlatformName" HeaderText="平台" />
                                <asp:BoundField DataField="ShopUrl" HeaderText="网址" />
                                <asp:BoundField DataField="Description" HeaderText="描述"  />
                                <asp:HyperLinkField DataNavigateUrlFields="ShopID" DataNavigateUrlFormatString="SysShopManager.aspx?action=edit&amp;ShopID={0}"
            ...
            <tr>
                ...
                <td align="center" style="width: 470px; height: 121px">
                    &nbsp;<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Shop/SysShopManager.aspx"
