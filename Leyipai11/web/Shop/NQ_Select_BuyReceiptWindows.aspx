<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NQ_Select_BuyReceiptWindows.aspx.cs" Inherits="Buy_NQ_Select_BuyReceiptWindows" %>
...
<td align="center" class="title" style="width: 810px">
	...
	<thead>
    		<tr>
    		    ...
    		    <th width="121" style="height: 16px"></th>
    		</tr>
    </thead>
    <tbody>
        ...
        <ItemTemplate>
           <tr>
            	<td>
            <a href="NQ_Select_BuyReceiptWindows.aspx?action=sel&ReceiptOrderID=<%#Eval("ReceiptOrderID")%>"><img alt="选择"  border="0" src="../images/Select.gif" /> </a>
            	</td>
            	<td><%#Eval("ReceiptOrderID")%></td>
