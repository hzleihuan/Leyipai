<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SysSalesPlatform.aspx.cs" Inherits="Customer_SysSalesPlatform" %>
        ...
        <table style="width: 849px">
                ...
                <td style="width: 470px">
                    <asp:Panel ID="editPanel" runat="server" Visible="False" Width="100%">
                        ...
                        <div style="border-right: #a4d5e3 1px solid; border-top: #a4d5e3 1px solid; background: url(../images/content_bg1.gif) repeat-x 50% bottom;
                            ...
                            border-bottom: #a4d5e3 1px solid; height: 149px">
                ...
                <td align="left" style="width: 470px; height: 121px">
                    <asp:Panel ID="viewPanel" runat="server"  Width="125px">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                            ...
                            <Columns>
                                <asp:BoundField DataField="PlatformID" HeaderText="编号"  >
                                    <ControlStyle Width="100px" />
                                    <HeaderStyle Width="80px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="PlatformName" HeaderText="平台名称"  >
                                    <ControlStyle Width="150px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Description" HeaderText="描述"  />
                                <asp:HyperLinkField DataNavigateUrlFields="PlatformID" DataNavigateUrlFormatString="SysSalesPlatform.aspx?action=edit&amp;PlatformID={0}"
                                    HeaderText="编辑" Text="&lt;img border=0 src=../images/Edit.gif /&gt;">
                                    <ItemStyle Width="30px" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField DataNavigateUrlFields="PlatformID" DataNavigateUrlFormatString="SysSalesPlatform.aspx?action=del&amp;PlatformID={0}"
            ...
            <tr>
                ...
                <td align="center" style="width: 470px; height: 121px">
                    &nbsp;<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Customer/SysSalesPlatform.aspx"
