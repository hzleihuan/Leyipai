<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuyReturn_Detail.aspx.cs" Inherits="Buy_BuyReturn_Detail" %>
...
function initload()
{
    ...
    var BuyReturnIDs = "";
    BuyReturnIDs=document.getElementById("BuyReturnID").value;
     var xmlHttps=this.createXmlHttp();                       
            ...
            xmlHttps.send("action=load&BuyReturnID="+BuyReturnIDs);//  
...
<TABLE id="Table1" cellspacing="0" cellpadding="1"  rules="all" bordercolor="Silver" border="1"  style="border-color:Silver;border-width:1px;border-style:solid;width:90%;border-collapse:collapse;">
							<TR height="40px">
								...
								<TD style="width: 132px; height: 40px" ><span id="InstockId">
                                    <asp:TextBox ID="BuyReturnID" runat="server" CssClass="txt_left"></asp:TextBox></span></TD>
								...
								<TD bgcolor=#FFFFFF style="width: 114px; height: 40px"><span id="Instockdata">
                                    <asp:TextBox ID="BuyReturnDate" runat="server" CssClass="txt_left"></asp:TextBox></span></TD>
