...
<td align="center" class="title" style="width: 810px">
	...
	<thead>
    		<tr>
            	...
            	<th width="121" style="height: 16px">入库日期</th>
    ...
    <tbody>
        ...
        <ItemTemplate>
           <tr>
            	<td>
            <a href="NQ_Select_BuyReceiptWindows.aspx?action=sel&ID=<%#Eval("ReceiptOrderID")%>"><img alt="选择"  border="0" src="../images/Select.gif" /> </a>
            	</td>
