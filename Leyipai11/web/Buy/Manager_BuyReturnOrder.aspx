<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manager_BuyReturnOrder.aspx.cs" Inherits="Buy_Manager_BuyReturnOrder" %>
...
body {
  ...
  <script type="text/javascript">
     ...
     }else
     {
      for( i=0;i<document.all.selOrder.length;i++)
        ...
        else
        {
           ...
           window.location.href("Manager_AuditingBuyReturnOrder.aspx?action="+action+"&AuditingId="+encodeURIComponent(str)) ;
        }
    ...
    function newAdd()
    {
       window.location.href("BuyReturn_Add.aspx");
    }
    </script>
</head>
<body>
  ...
  <table width="100%" border="0">
    <tr>
      ...
      <td style="height: 21px">
          &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<input type="button"  name="shenhe" value="审核退单" id="Submit1" onclick="javascript:if(!confirm('您确定要审核吗'))return  false;shenheSubmit('shenhe')" style="width: 81px" /> &nbsp; &nbsp; &nbsp; &nbsp;
          ...
          &nbsp;&nbsp;
          <input type="button"  name="shenhe" value="新添采购退货" id="Button2" onclick="newAdd()" style="width: 103px" />
      </td>
    </tr>
  </table>
  ...
  <table width="900" border="0">
    <tr>
     <td style="width: 175px">单据编号：<asp:TextBox ID="ReceiptOrderID" runat="server" Width="105px"></asp:TextBox></td>
...
<td align="center" class="title" style="width: 810px; height: 38px;">
    ...
    <tbody>
        ...
        <ItemTemplate>
           <tr>
            	<td><input type="checkbox" name="selOrder" value="<%#Eval("BuyReturnID")%>" />
            	
            	</td>
            	<td>
            	<a target="_blank" href="BuyReturn_Detail.aspx?BuyReturnID=<%#Eval("BuyReturnID")%>"><%#Eval("BuyReturnID")%></a>
            	
            	</td>
            	<td><%#Eval("BuyReturnDate")%> </td>
