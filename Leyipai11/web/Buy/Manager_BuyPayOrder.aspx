<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manager_BuyPayOrder.aspx.cs" Inherits="Buy_Manager_BuyPayOrder" %>
...
body {
  ...
  <script type="text/javascript">
      ...
      for( i=0;i<document.all.selOrder.length;i++)
        ...
        else
        {
          // window.location.replace("Manager_AuditingBuyOrder.aspx?AuditingId="+encodeURIComponent(str)) ;
           window.location.href("Manager_AuditingBuyPay.aspx?action="+action+"&AuditingId="+encodeURIComponent(str)) ;
        }
    ...
    function newAdd()
    {
       window.location.href("BuyPay_Add.aspx");
    }
    </script>
</head>
<body>
  ...
  <table width="100%" border="0">
    <tr>
      ...
      <td style="height: 21px">
          &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<input type="button"  name="shenhe" value="审核付款单" id="Submit1" onclick="javascript:if(!confirm('您确定要操作吗'))return  false;shenheSubmit('shenhe')" style="width: 81px" /> &nbsp; &nbsp; &nbsp; &nbsp;
          <input type="button"  name="shenhe" value="删除付款单" id="Button1" onclick="javascript:if(!confirm('您确定要删除吗'))return  false;shenheSubmit('delete')" style="width: 89px" />
          &nbsp;&nbsp;
          <input type="button"  name="shenhe" value="新添付款单" id="Button2" onclick="newAdd()" style="width: 103px" />
      </td>
    </tr>
  </table>
...
<td >
   <table width="820"  class="flexme2">
    ...
    <tbody>
        ...
        <ItemTemplate>
           <tr>
            	<td><input type="checkbox" name="selOrder" value="<%#Eval("PayID")%>" />
