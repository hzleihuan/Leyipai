<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manager_InventoryOrder.aspx.cs" Inherits="Stock_Manager_InventoryOrder" %>
...
body {
  ...
  <script type="text/javascript">
      ...
      for( i=0;i<document.all.selOrder.length;i++)
        ...
        else
        {
          // window.location.replace("Manager_AuditingBuyOrder.aspx?AuditingId="+encodeURIComponent(str)) ;
           window.location.href("Manager_AuditingInventoryOrder.aspx?action="+action+"&AuditingId="+encodeURIComponent(str)) ;
        }
    ...
    function newAdd()
    {
       window.location.href("Inventory_Add.aspx");
    }
    </script>
</head>
<body>
  ...
  <table width="100%" border="0">
    <tr>
      ...
      <td style="height: 21px">
          &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<input type="button"  name="shenhe" value="审核盘点单" id="Submit1" onclick="javascript:if(!confirm('您确定要操作吗'))return  false;shenheSubmit('shenhe')" style="width: 81px" /> &nbsp; &nbsp; &nbsp; &nbsp;
          ...
          &nbsp;&nbsp;
          <input type="button"  name="shenhe" value="新添盘点" id="Button2" onclick="newAdd()" style="width: 103px" />
      </td>
    </tr>
  </table>
  ...
  <table width="900" border="0">
    <tr>
     <td style="width: 175px">单据编号：<asp:TextBox ID="TransferringOrderID" runat="server" Width="105px"></asp:TextBox></td>
...
<td align="center" class="title" style="width: 810px; height: 38px;">
    ...
    <tr>
        <td align="center"  style="width: 900px; height: 38px;">
    ...
    <tbody>
        ...
        <ItemTemplate>
           <tr>
            	<td><input type="checkbox" name="selOrder" value="<%#Eval("InventoryID")%>" />
                ...
                <td><%#Eval("RealityNum")%></td>
                <td><%#Eval("AdjustNum")%></td>
