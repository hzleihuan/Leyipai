<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OutStock_Detail.aspx.cs" Inherits="Stock_OutStock_Detail" %>
...
function initload()
{
    ...
    var AppendIDs = "";
    AppendIDs=document.getElementById("OutID").value;
     var xmlHttps=this.createXmlHttp();                       
            ...
            xmlHttps.send("action=load&OutID="+AppendIDs);//  
...
<TABLE id="Table1" cellspacing="0" cellpadding="1"  rules="all" bordercolor="Silver" border="1"  style="border-color:Silver;border-width:1px;border-style:solid;width:90%;border-collapse:collapse;">
							<TR height="40px">
								...
								<TD style="width: 132px; height: 40px" ><span id="InstockId">
                                    <asp:TextBox ID="OutID" runat="server" CssClass="txt_left"></asp:TextBox></span></TD>
    ...
    <tr height="40">
        ...
        <th style="width: 91px; height: 40px;">
            出库类型：</th>
        <td style="width: 114px; height: 40px;">
            <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></td>
        <th style="width: 79px; height: 40px;">
        </th>
