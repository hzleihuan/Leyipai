<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppendStock_Detail.aspx.cs" Inherits="Stock_AppendStock_Detail" %>
...
function initload()
{
    ...
    var AppendIDs = "";
    AppendIDs=document.getElementById("AppendID").value;
     var xmlHttps=this.createXmlHttp();                       
            ...
            xmlHttps.send("action=load&AppendID="+AppendIDs);//  
...
<TABLE id="Table1" cellspacing="0" cellpadding="1"  rules="all" bordercolor="Silver" border="1"  style="border-color:Silver;border-width:1px;border-style:solid;width:90%;border-collapse:collapse;">
							<TR height="40px">
								...
								<TD style="width: 132px; height: 40px" ><span id="InstockId">
                                    <asp:TextBox ID="AppendID" runat="server" CssClass="txt_left"></asp:TextBox></span></TD>
