<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manager_TransferringOrder.aspx.cs" Inherits="Stock_Manager_TransferringOrder" %>
...
body {
  ...
  <script type="text/javascript">
      ...
      for( i=0;i<document.all.selOrder.length;i++)
        ...
        else
        {
          // window.location.replace("Manager_AuditingBuyOrder.aspx?AuditingId="+encodeURIComponent(str)) ;
           window.location.href("Manager_AuditingTransferringOrder.aspx?action="+action+"&AuditingId="+encodeURIComponent(str)) ;
        }
    ...
    function newAdd()
    {
       window.location.href("TransferringOrder_Add.aspx");
    }
    </script>
</head>
<body>
  ...
  <table width="100%" border="0">
    <tr>
      ...
      <td style="height: 21px">
          &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<input type="button"  name="shenhe" value="审核调拔" id="Submit1" onclick="javascript:if(!confirm('您确定要操作吗'))return  false;shenheSubmit('shenhe')" style="width: 81px" /> &nbsp; &nbsp; &nbsp; &nbsp;
          ...
          &nbsp;&nbsp;
          <input type="button"  name="shenhe" value="新添调拨单" id="Button2" onclick="newAdd()" style="width: 103px" />
      </td>
    </tr>
  </table>
    ...
    <tbody>
        ...
        <ItemTemplate>
           <tr>
            	...
            	<td><%#Eval("Quantity")%></td>
            	<td><%#Eval("OutHouseName")%>--<%#Eval("OutSubareaName")%></td>
            	<td><%#Eval("InHouseName")%>--<%#Eval("InSubareaName")%></td>
