...
public partial class Stock_Manager_AuditingInventoryOrder : ManagerInventory
{
    ...
    protected void init()
    {
        ...
        if (action.Equals("shenhe"))
        {
            ...
            Leyp.SQLServerDAL.Stock.InventoryDAL bl = new Leyp.SQLServerDAL.Stock.InventoryDAL();
            int num = 0;
            ...
            sb.Append("成功审核 " + num + "条 <a href=\"Manager_InventoryOrder.aspx\">返回列表</a>");
