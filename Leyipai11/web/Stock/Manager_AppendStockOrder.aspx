<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manager_AppendStockOrder.aspx.cs" Inherits="Stock_Manager_AppendStockOrder" %>
...
<body>
  ...
  <table width="100%" border="0">
    <tr>
      ...
      <td style="height: 21px">
          &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<input type="button"  name="shenhe" value="审核入库" id="Submit1" onclick="javascript:if(!confirm('您确定要操作吗'))return  false;shenheSubmit('shenhe')" style="width: 81px" /> &nbsp; &nbsp; &nbsp; &nbsp;
          ...
          &nbsp;&nbsp;
          <input type="button"  name="shenhe" value="新添入库单" id="Button2" onclick="newAdd()" style="width: 103px" />
      </td>
    </tr>
  </table>
  ...
  <table width="900" border="0">
    <tr>
     <td style="width: 175px">入库编号：<asp:TextBox ID="TransferringOrderID" runat="server" Width="105px"></asp:TextBox></td>
...
<td align="center" class="title" style="width: 810px; height: 38px;">
    ...
    <tbody>
        ...
        <ItemTemplate>
           <tr>
            	<td><input type="checkbox" name="selOrder" value="<%#Eval("AppendID")%>" />
            	
            	</td>
            	<td>
            	<a target="_blank" href="AppendStock_Detail.aspx?AppendID=<%#Eval("AppendID")%>"><%#Eval("AppendID")%></a>
            	
            	</td>
            
            	<td><%#changString0(Eval("AppendType").ToString())%></td>
