<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SysDeliverManager.aspx.cs" Inherits="Delivery_SysDeliverManager" %>
...
<body>
    ...
    <div>
        <asp:SiteMapPath ID="SiteMapPath1" runat="server">
         ...
         &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="?action=updateDefault"
                            Width="146px">进入设置默认首选项</asp:HyperLink><br />
        <table style="width: 849px">
                ...
                <td align="left" style="width: 470px; height: 121px">
                    <asp:Panel ID="viewPanel" runat="server"  Width="125px">
                                ...
                                <table style="width: 489px">
                                    <tr>
                                        <td style="width: 29%; height: 43px">
                                            <span></span><span style="font-size: 9pt;">配送</span>名称</td>
                                        <td style="width: 50%; height: 43px">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                            BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Width="732px">
                            <FooterStyle BackColor="#99CCCC" ForeColor="#003399" />
                            <Columns>
                                <asp:BoundField DataField="DeliveryID" HeaderText="编号"  >
                                    <ControlStyle Width="100px" />
                                    <HeaderStyle Width="80px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="DeliveryName" HeaderText="名称" ItemStyle-Width="100px"  />
                                    
                             
                                <asp:BoundField DataField="Description" HeaderText="描述"  />
                                <asp:BoundField DataField="Default" HeaderText="1为默认首选" ItemStyle-Width="80px" />
                                <asp:HyperLinkField DataNavigateUrlFields="DeliveryID" DataNavigateUrlFormatString="SysDeliverManager.aspx?action=edit&amp;DeliveryID={0}"
                                    HeaderText="编辑" Text="&lt;img border=0 src=../images/Edit.gif /&gt;">
                                    <ItemStyle Width="30px" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField DataNavigateUrlFields="DeliveryID" DataNavigateUrlFormatString="SysDeliverManager.aspx?action=del&amp;DeliveryID={0}"
            ...
            <tr>
                ...
                <td align="center" style="width: 470px; height: 121px">
                    <asp:Panel ID="updateDefaultPanel" runat="server" Height="50px" Visible="False" Width="125px">
                        <table style="width: 682px">
                            <tr>
                                ...
                                <td>
                                    <cc2:DeliveryDropDownList ID="DeliveryDropDownList1" runat="server">
                                    </cc2:DeliveryDropDownList>
                                </td>
                                <td>
                                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="提交" Width="61px" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    &nbsp;<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Delivery/SysDeliverManager.aspx"
