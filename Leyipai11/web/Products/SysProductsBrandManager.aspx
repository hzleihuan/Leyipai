<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SysProductsBrandManager.aspx.cs" Inherits="Products_SysProductsBrandManager" %>
        ...
        <table style="width: 849px">
                                ...
                                <table style="width: 489px">
                                    <tr>
                                        ...
                                        <td style="width: 50%; height: 43px">
                                            <asp:TextBox ID="BrandName_edit" runat="server" Width="140px"></asp:TextBox>
                                            <asp:Label ID="BrandID" runat="server" Visible="False"></asp:Label>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="BrandName_edit"
                ...
                <td align="left" style="width: 470px; height: 121px">
                    <asp:Panel ID="viewPanel" runat="server" Width="125px">
                                ...
                                <table style="width: 489px">
                                    <tr>
                                        <td style="width: 29%; height: 43px">
                                            品牌名称：</td>
                                        <td style="width: 50%; height: 43px">
                                            <asp:TextBox ID="BrandName_New" runat="server" Width="95px"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="BrandName_New"
                                    ...
                                    <tr>
                                        <td style="width: 29%; height: 27px">
                                            状 态</td>
                                        <td style="width: 50%; height: 27px">
                                            <asp:DropDownList ID="State_new" runat="server">
                                             <asp:ListItem Value="Y">正常使用</asp:ListItem>
                                                <asp:ListItem Value="N">停止使用</asp:ListItem>
                                            </asp:DropDownList></td>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                            BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Width="817px">
                            <FooterStyle BackColor="#99CCCC" ForeColor="#003399" />
                            <Columns>
                                <asp:BoundField DataField="BrandID" HeaderText="编号"  >
                                    <ControlStyle Width="100px" />
                                    <HeaderStyle Width="50px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="BrandName" HeaderText="名称"  >
                                ...
                                <asp:HyperLinkField DataNavigateUrlFields="BrandID" DataNavigateUrlFormatString="SysProductsBrandManager.aspx?action=edit&amp;BrandID={0}"
                                    HeaderText="编辑" Text="&lt;img border=0 src=../images/Edit.gif /&gt;">
                                    <ItemStyle Width="30px" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField DataNavigateUrlFields="BrandID" DataNavigateUrlFormatString="SysProductsBrandManager.aspx?action=del&amp;BrandID={0}"
            ...
            <tr>
                ...
                <td align="center" style="width: 470px; height: 121px">
                    &nbsp;<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Products/SysProductsBrandManager.aspx"
