<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesReport_Products.aspx.cs" Inherits="Sales_SalesReport_Products" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>管理：：销售报表统计：按商品销量统计</title>
    ...
    <tr>
     ...
     从:
      ...
      <td style="width: 188px; height: 23px;">
          统计销售前： &nbsp;<asp:TextBox ID="TextBox1" runat="server" Width="29px"></asp:TextBox>
          名</td>
