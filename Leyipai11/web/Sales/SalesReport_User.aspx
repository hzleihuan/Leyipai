<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesReport_User.aspx.cs" Inherits="Sales_SalesReport_User" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>管理：：销售报表统计：按用户销量统计</title>
    ...
    <tr>
     ...
     从:
      ...
      <td style="width: 188px; height: 23px;">
          销售金额：<asp:DropDownList ID="DropDownList1" runat="server">
              <asp:ListItem Value="-1">请选择</asp:ListItem>
              <asp:ListItem Value="０">10000以上</asp:ListItem>
              <asp:ListItem Value="1">5000到10000</asp:ListItem>
              <asp:ListItem Value="2">1000到5000</asp:ListItem>
              <asp:ListItem Value="3">100到1000</asp:ListItem>
              <asp:ListItem Value="4">100以下</asp:ListItem>
          </asp:DropDownList>
          &nbsp;&nbsp;</td>
      <td style="width: 228px; height: 23px;" align="left">
          <asp:Button ID="Total" runat="server"
              Text="统计" OnClientClick="return checkDate()"  Width="77px"  /></td>
    </tr>
  </table>
</DIV>
