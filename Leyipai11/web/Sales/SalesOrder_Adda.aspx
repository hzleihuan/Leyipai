<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesOrder_Adda.aspx.cs" Inherits="Sales_SalesOrder_Adda" %>
     ...
     $.blockUI({message:"<img src=\"../images/load.gif\" />"});//阴影                     
            xmlHttp.onreadystatechange = function() {
                if (xmlHttp.readyState == 4) {  
                   ...
                   alert("添加成功！");
                   window.location.href="MySalesOrder.aspx" ;
                   
                }
            }
            xmlHttp.open("POST", "AjaxSalesOrderLoad.aspx", true);
            xmlHttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
            xmlHttp.send("action=addHeadTable&SalesOrderID="+node2.value+"&ClosingDate="+node0.value+"&DeliveryType="+node1.value+"&CreateDate="+node3.value+"&DeliveryPlace="+node4.value+"&ClosingType="+node5.value+"&ShopID="+node6.value+"&AttachPay="+node7.value+"&Description="+strs+"&Discount="+node9.value+"&CustomerID="+node10.value+"&CustomerName="+node11.value+"&CustomerTel="+node12.value+"&CustomerPost="+node13.value+"&CustomerArea="+node14.value+"&PlatformID="+node15.value+"");//   
...
function checknext5()
{
   var no= document.getElementById("PayInfo");
  if(no.value == "")
  {
   alert("还没有填写任何付款信息");
   return false;
...
//放弃 完成付款
function checknext5a()
{
  finshNextSet();
}

//最后一步设置
function finshNextSet()
{
    ...
    this.document.getElementById("next4a").style.display='none';
    this.document.getElementById("next5").style.display='none';
    this.document.getElementById("next5a").style.display='none';
}
                                    ...
                                    <TBODY>
                                        <TR>
                                            ...
                                            <TD bgColor=#ffffff style="height: 1px; width: 378px;" colspan="2" align="left">
                                                &nbsp;顾客聊号：<asp:TextBox ID="CustomerID" runat="server" CssClass="txt_left" 
                                                    Width="99px"></asp:TextBox>（如QQ）</td>
                                        </tr>
                                        <TR>
                    ...
                    <TBODY>
                        <TR>
                            <TD bgColor=#ffffff style="height: 118px; width: 810px;" valign="top" align="center">
                                ...
                                您选择的配送方式是：<asp:TextBox ID="DeliveryType" runat="server" CssClass="txt_left" ReadOnly="True"
                        ...
                        <TR>
                            <TD bgColor=#ffffff style="height: 118px; width: 910px;" valign="top" align="center">
                                <TABLE cellSpacing=1 cellPadding=1 width="100%" align=center border=0>
                                    <TBODY>
                                        <TR>
                                            <TD bgColor=#ffffff style="width: 264px; height: 38px" align="left" >
                                            ...
                                            <TD bgColor=#ffffff style="height: 38px; width: 378px;" align="left" >
                                                &nbsp;结算方式： &nbsp;
                                ...
                                &nbsp;<input id="next4"  onclick="checknext4()" style="width: 97px" type="button" value="保存进入下一步" />
                                &nbsp; &nbsp; &nbsp; &nbsp;
                                <input id="next4a"  onclick="checknext4a()" style="width: 96px" type="button" value="立即去付款提交" /></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                    ...
                    <TBODY>
                        <TR>
                            <TD bgColor=#ffffff style="height: 74px; width: 910px;" valign="top" align="center"><input id="PayInfo" class="txt_left" 
                                                        style="width: 428px; height: 17px;" type="text" />
                                请填写您为本单据所付款情况和交易号<br />
                                <br />
                                <input id="next5" onclick="checknext5()" style="width: 106px" type="button" value="保存进入下一步" />
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                                &nbsp;<input id="next5a" onclick="checknext5a()" style="width: 100px" type="button" value="跳过这一步" /></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                    ...
                    <TBODY>
                        <TR>
                            <TD bgColor=#ffffff style="height: 74px; width: 910px;" valign="top" align="center">
                                &nbsp;<input id="Button5" onclick="javascript:if(!confirm('您确定要完成订单吗'))return  false;checkheadTable()" style="width: 113px" type="button" value="提 交 订 单" /></td>
                        </tr>
                    </tbody>
                </table>
            </div>
