<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NQ_Select_SalesOrderWindows.aspx.cs" Inherits="Sales_NQ_Select_SalesOrderWindows" %>
...
<td align="center" class="title" style="width: 810px">
    ...
    <tbody>
        ...
        <ItemTemplate>
           <tr>
            	<td>
            <a href="NQ_Select_SalesOrderWindows.aspx?action=sel&ID=<%#Eval("SalesOrderID")%>"><img alt="选择"  border="0" src="../images/Select.gif" /> </a>
            	</td>
