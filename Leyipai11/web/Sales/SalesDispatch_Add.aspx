<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesDispatch_Add.aspx.cs" Inherits="Sales_SalesDispatch_Add" %>
      ...
      <TABLE  id="addModlue" cellSpacing=1 cellPadding=1 width="100%" align=center border=0>
        ...
        <TR>
          ...
          <TD bgColor=#ffffff style="height: 9px; width: 418px;" align="left">
              配送方式： &nbsp;&nbsp;&nbsp;&nbsp;
              <asp:TextBox ID="DeliveryID" runat="server" CssClass="txt_left" Width="154px" ReadOnly="True"></asp:TextBox>
              </TD>
        ...
        &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<asp:Button ID="gotoList" runat="server"
            Text="返回列表" OnClick="gotoList_Click" /></TD></TR>
  </TBODY></TABLE>
