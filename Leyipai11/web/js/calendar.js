...
//return:包含月历的 5*7 二维数组，非该月的为相应的负数。
function fBuildCal(iYear, iMonth) {
  var aMonth=new Array();
  for(i=1;i<7;i++)
  	aMonth[i]=new Array(i);
  
  var dCalDate=new Date(iYear, iMonth-1, 1);//该月的第一天
  var iDayOfFirst=dCalDate.getDay();//该月第一天的星期号数
  var iDaysInMonth=new Date(iYear, iMonth, 0).getDate();//该月的天数
