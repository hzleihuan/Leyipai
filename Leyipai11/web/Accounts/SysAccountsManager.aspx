<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SysAccountsManager.aspx.cs" Inherits="Accounts_SysAccountsManager" %>
        ...
        <table style="width: 849px">
            ...
            <tr>
                ...
                <td style="width: 470px">
                    <asp:Panel ID="editPanel" runat="server" Height="100%" Visible="False" Width="100%">
                        <br />
                                ...
                                <table style="width: 489px">
                                    <tr>
                                        ...
                                        <td style="width: 50%; height: 43px">
                                            <asp:TextBox ID="AccountsID_edit" runat="server" Width="140px" ReadOnly="True"></asp:TextBox>&nbsp;
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 43%; height: 43px">
                                            帐号名称</td>
                                        <td style="width: 50%; height: 43px">
                                            <asp:TextBox ID="AccountsName_Edit" runat="server" Width="95px"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="AccountsName_Edit"
                ...
                <td align="left" style="width: 470px; height: 121px">
                    <asp:Panel ID="viewPanel" runat="server"  Width="125px">
                                ...
                                <table style="width: 489px">
                                    <tr>
                                        <td style="width: 29%; height: 43px">
                                            <span style="font-size: 10pt; font-family: 宋体">帐号ID</span></td>
                                        <td style="width: 50%; height: 43px">
                                            <asp:TextBox ID="AccountsID_New" runat="server" Width="95px"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="AccountsID_New"
                                    ...
                                    <tr>
                                        <td style="width: 29%; height: 43px">
                                            帐号名称</td>
                                        <td style="width: 50%; height: 43px">
                                            <asp:TextBox ID="AccountsName_New" runat="server" Width="95px"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="AccountsName_New"
                                                ErrorMessage="<img src=../images/false.gif  />不能为空"></asp:RequiredFieldValidator></td>
                                        <td style="width: 40%; height: 43px">
                                        </td>
                                    </tr>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                            BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Width="745px">
                            <FooterStyle BackColor="#99CCCC" ForeColor="#003399" />
                            <Columns>
                                <asp:BoundField DataField="AccountsID" HeaderText="帐号ID"  >
                                    <ControlStyle Width="100px" />
                                    <HeaderStyle Width="80px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="AccountsName" HeaderText="帐号名称"  >
                                    <ControlStyle Width="150px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Description" HeaderText="描述"  />
                                <asp:HyperLinkField DataNavigateUrlFields="AccountsID" DataNavigateUrlFormatString="SysAccountsManager.aspx?action=edit&amp;AccountsID={0}"
            ...
            <tr>
                ...
                <td align="center" style="width: 470px; height: 121px">
                    &nbsp;<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Accounts/SysAccountsManager.aspx"
