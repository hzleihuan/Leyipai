<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaManger.aspx.cs" Inherits="Admin_c_AreaManger" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../js/c/AreaManger.js"></script>
    <link rel="stylesheet" type="text/css" media="all" href="../css/ext-common.css" />
</head>
<body>
    <div id="treeList" style="margin-top:8px; width:300px">
