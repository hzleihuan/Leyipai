<%@ WebHandler Language="C#" Class="AddOrderDetail" %>
...
using Newtonsoft.Json;
 ...
 /// <summary>
    ...
    /// </summary>
    public class AddOrderDetail : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                string[] nodes = orderstr.Split(new char[] { ',' });// 订单号$价钱$折扣$数量
