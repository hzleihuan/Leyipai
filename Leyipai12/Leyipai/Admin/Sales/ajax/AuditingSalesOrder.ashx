<%@ WebHandler Language="C#" Class="AuditingSalesOrder" %>
...
/// <summary>
    /// AuditingSalesOrder 的摘要说明
    /// </summary>
    public class AuditingSalesOrder : IHttpHandler, IRequiresSessionState
    {
        Leyipai.BLL.SalesOrderBLL bll = new Leyipai.BLL.SalesOrderBLL();
        public void ProcessRequest(HttpContext context)
        {
            if (bll.isHavePurview(context, 13))
            {
                ...
                string ss = bll.AuditingOrders(username, ids);
