<%@ WebHandler Language="C#" Class="getSalesOrderList" %>
...
/// <summary>
    /// getSalesOrderList 的摘要说明
    /// </summary>
    public class getSalesOrderList : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            Leyipai.Common.Page<Leyipai.Model.sales_order> page = bll.GetListByPage(startInt, limitInt, orderNum, bdate, edate,null);
            page.success = true;
