<%@ WebHandler Language="C#" Class="UnAuditingOrders" %>
...
using Newtonsoft.Json;
    ...
    /// <summary>
    /// UnAuditingOrders 的摘要说明
    /// </summary>
    public class UnAuditingOrders : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (bll.isHavePurview(context, 13))
            {
                ...
                string ss = bll.UnAuditingOrders(username, ids);
