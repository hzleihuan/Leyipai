...
namespace Leyipai.Common
{
	...
	public class PageBase:System.Web.UI.Page
	{
       ...
       // string virtualPath = Leyipai.Common.ConfigHelper.GetConfigString("VirtualPath");
        public string basePath = HttpContext.Current.Request.ApplicationPath;
		/// <summary>
		/// 构造函数
		/// </summary>
		public PageBase()
		...
		private void PageBase_Load(object sender, EventArgs e)
		{
			if (!Page.IsPostBack )
			{
                ...
                if (Context.User.Identity.IsAuthenticated)
                {
                    ...
                    //{
                    //    Leyipai.Accounts.Bus.User currentUser = new LTP.Accounts.Bus.User(user);
